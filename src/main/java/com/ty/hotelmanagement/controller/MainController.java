...
import com.ty.hotelmanagement.dao.FoodOrderDao;
import com.ty.hotelmanagement.dao.MenuDao;
import com.ty.hotelmanagement.dao.UserDao;
import com.ty.hotelmanagement.dto.FoodItems;
import com.ty.hotelmanagement.dto.FoodOrder;
import com.ty.hotelmanagement.dto.Menu;
import com.ty.hotelmanagement.dto.Product;
import com.ty.hotelmanagement.dto.User;
				...
				if (user.getPassword().equals(password)) {
					if (user.getRole().equals("Manager")) {
						...
						case 2:
							// update menu
							Menu menu1=new Menu();
							System.out.println("Enter the menu name that you want to update");
